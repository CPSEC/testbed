...
# set_speed = LPulse()
# V.add(set_speed, outputs=['refer_speed','recording'])

V.mem.put(['refer_speed', 'throttle-P', 'throttle-I', 'throttle-D'], [40, cfg.PID_P, cfg.PID_I, cfg.PID_D])
...
cse = CSE()
V.add(cse, inputs=['refer_speed', 'as5048a'], outputs=['cse/error'])

throttle = PIDController()
car_speed = PIDSpeed(throttle)
V.add(car_speed, inputs=['throttle-P', 'throttle-I', 'throttle-D', 'cse/error'], outputs=['user/throttle', 'recording'])
...
# data save
inputs= ['as5048a','user/throttle','ads1115/vm','user/angle', 'bias', 'radius', 'hcsr04','ads1115/vp',
         'bno055/heading',"bno055/roll", "bno055/pitch",
         "bno055/ori_x", "bno055/ori_y", "bno055/ori_z","bno055/ori_w",
         "bno055/temp_c", "bno055/mag_x", "bno055/mag_y", "bno055/mag_z",
         "bno055/gyr_x", "bno055/gyr_y", "bno055/gyr_z",
         "bno055/acc_x", "bno055/acc_y", "bno055/acc_z",
         "bno055/lacc_x","bno055/lacc_y", "bno055/lacc_z",
         "bno055/gra_x", "bno055/gra_y", "bno055/gra_z"
         ]
...
# tub = th.new_tub_writer(inputs=tub_inputs, types=tub_types, user_meta=meta)
# V.add(tub, inputs=tub_inputs, outputs=["tub/num_records"], run_condition='recording')

# transfer data

writer = SocketData(inputs=inputs)
V.add(writer, inputs=inputs, outputs=['refer_speed','throttle-P','throttle-I','throttle-D'], threaded=True, run_condition='recording')
