...
from custom_parts.PredictedSpeed import PredictedSpeed
...
# V.add(car_speed, inputs=['cse/error'], outputs=['user/throttle'])
V.add(car_speed, inputs=[cfg.PID_P, cfg.PID_I, cfg.PID_D, 'cse/error'], outputs=['user/throttle'])
...
# data save
inputs = ['hcsr04', 'ads1115/vm', 'ads1115/vp', 'as5048a', 'speed', 'refer_speed', 'cse/error', "bno055/heading", "bno055/roll", "bno055/pitch",
...
types = ['float', 'float', 'float', 'int', 'float', 'float', 'float', 'float', 'float', 'float',
         'float', 'float', 'float',
