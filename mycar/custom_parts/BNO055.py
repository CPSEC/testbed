...
if __name__ == "__main__":
    B = BNO055()
    while True:
         print("Temperature: {} degrees C".format(B.sensor.temperature))
         print("Accelerometer (m/s^2): {}".format(B.sensor.acceleration))
         print("Magnetometer (microteslas): {}".format(B.sensor.magnetic))
         print("Gyroscope (rad/sec): {}".format(B.sensor.gyro))
         print("Euler angle: {}".format(B.sensor.euler))
         print("Quaternion: {}".format(B.sensor.quaternion))
         print("Linear acceleration (m/s^2): {}".format(B.sensor.linear_acceleration))
         print("Gravity (m/s^2): {}".format(B.sensor.gravity))
         print()
